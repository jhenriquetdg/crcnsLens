use crate::{global, types::Dataset};

// pub fn filelist(ui: &mut egui::Ui) {
//     let state = global::get_state();
//     let dataset = state.working_dataset.lock().unwrap();
//     if *dataset == Dataset::default() {
//         return;
//     }
//
//     let files = state.working_files.lock().unwrap();
//     let collection = state.working_collection.lock().unwrap();
//     println!("ok");
//     // dataset.
// }
//

use crate::gui::traits::{Display, View};
use egui::TextStyle;
